...
<div>
	...
	<div class="overlay-content" onmousemove={handleMousemove} aria-label="Stuff" role="application">
		<div>
			<!-- <h1>WE'RE BUILDING A NEW KIND OF TELESCOPE</h1> -->
		</div>
		<div>
			<div class="description-wrapper glass">
				<h2 bind:this={titleEl}>{carouselData[curCarouselItemIndex].title}</h2>
...
<style>
	...
	h1 {
		...
		/* To handle the visual effect of the big letter */
	...
	.overlay-content {
		...
		/* FYI/TODO: totally ignoring accessbility */
		/* TODO: this is needed for the camera position to be accessed */
		/* pointer-events: none; */
